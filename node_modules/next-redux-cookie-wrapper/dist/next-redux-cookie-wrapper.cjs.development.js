...
var StateCookies = /*#__PURE__*/function () {
  ...
  StateCookies._decodeState = function _decodeState(state, compressed) {
    return JSON.parse((compressed ? lzString.decompressFromEncodedURIComponent : decodeURIComponent)(state));
  }
  /**
  ...
  _proto.getAll = function getAll() {
    ...
    if (typeof this._cookies === "undefined" || isClient()) {
      ...
      for (var _i = 0, _Object$entries = Object.entries(nookies.parseCookies(this._context, {
  ...
  _proto.set = function set(name, state) {
    ...
    nookies.setCookie(this._context, name, state, _extends({}, cookieOptions, {
...
var walkState = function walkState(subtrees, walker, stateA, stateB) {
  return (// @ts-ignore https://github.com/immerjs/immer/issues/839
    immer.produce(stateA, function (draftState) {
...
exports.SERVE_COOKIES = SERVE_COOKIES;
exports.nextReduxCookieMiddleware = nextReduxCookieMiddleware;
exports.wrapMakeStore = wrapMakeStore;
//# sourceMappingURL=next-redux-cookie-wrapper.cjs.development.js.map
