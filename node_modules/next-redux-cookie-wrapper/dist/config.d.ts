...
export declare type CookieOptions = Except<CookieSerializeOptions, "encode" | "httpOnly">;
...
export interface InternalSubtreeConfig extends Except<SetRequired<SubtreeConfig, "cookieName" | "ignoreStateFromStaticProps" | "compress">, keyof CookieOptions> {
 ...
 * but `false` for `three`.
 */
export interface NextReduxCookieMiddlewareConfig extends Except<SubtreeConfig, "subtree" | "cookieName"> {
    /**
 ...
 */
export declare function processMiddlewareConfig(config: NextReduxCookieMiddlewareConfig): InternalSubtreeConfig[];
